...
import com.haxi.mh.utils.ui.recyclerview.recyclerviewUtils;
import com.haxi.mh.utils.ui.recyclerview.ViewHolder;
import com.haxi.mh.utils.ui.recyclerview.interfaces.OnLoadMoreListener;
...
public abstract class BaseAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    private int findLastVisibleItemPosition(RecyclerView.LayoutManager layoutManager) {
        if (layoutManager instanceof LinearLayoutManager) {
            ...
            return recyclerviewUtils.findMax(lastVisibleItemPositions);
        }
        return -1;
    }
    ...
    public void setLoadingView(int loadingId) {
        setLoadingView(recyclerviewUtils.inflate(mContext, loadingId));
    }
    ...
    public void setLoadFailedView(int loadFailedId) {
        setLoadFailedView(recyclerviewUtils.inflate(mContext, loadFailedId));
    }
    ...
    public void setLoadEndView(int loadEndId) {
        setLoadEndView(recyclerviewUtils.inflate(mContext, loadEndId));
    }
