...
import com.haxi.mh.utils.background.models.AndroidAppProcess;
...
/**
 * 判断是APP在前台 还是后台  在BaseActivity 的生命周期做处理在 onStart 和 onPause 做相应事件
...
public class BackgroundUtils {
    ...
    public static boolean getFromAccessibilityService(Context context, String packageName) {
        if (DetectService.isAccessibilitySettingsOn(context) == true) {
            ...
            Log.e("wenming", "**方法五** 当前窗口焦点对应的包名为： =" + foreground);
