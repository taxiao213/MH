package com.haxi.mh.utils.ui.smartrefreshlayout;
...
import com.haxi.mh.utils.ui.smartrefreshlayout.api.DefaultRefreshInitializer;
import com.haxi.mh.utils.ui.smartrefreshlayout.api.RefreshContent;
...
import com.haxi.mh.utils.ui.smartrefreshlayout.api.ScrollBoundaryDecider;
import com.haxi.mh.utils.ui.smartrefreshlayout.constant.DimensionStatus;
...
import com.haxi.mh.utils.ui.smartrefreshlayout.footer.BallPulseFooter;
import com.haxi.mh.utils.ui.smartrefreshlayout.header.BezierRadarHeader;
import com.haxi.mh.utils.ui.smartrefreshlayout.impl.RefreshContentWrapper;
import com.haxi.mh.utils.ui.smartrefreshlayout.impl.RefreshFooterWrapper;
import com.haxi.mh.utils.ui.smartrefreshlayout.impl.RefreshHeaderWrapper;
import com.haxi.mh.utils.ui.smartrefreshlayout.listener.OnLoadMoreListener;
import com.haxi.mh.utils.ui.smartrefreshlayout.listener.OnMultiPurposeListener;
import com.haxi.mh.utils.ui.smartrefreshlayout.listener.OnRefreshListener;
import com.haxi.mh.utils.ui.smartrefreshlayout.listener.OnRefreshLoadMoreListener;
import com.haxi.mh.utils.ui.smartrefreshlayout.listener.OnStateChangedListener;
import com.haxi.mh.utils.ui.smartrefreshlayout.util.DelayedRunnable;
import com.haxi.mh.utils.ui.smartrefreshlayout.util.DensityUtil;
import com.haxi.mh.utils.ui.smartrefreshlayout.util.ViscousFluidInterpolator;
...
import static com.haxi.mh.utils.ui.smartrefreshlayout.util.DensityUtil.dp2px;
import static com.haxi.mh.utils.ui.smartrefreshlayout.util.SmartUtil.fling;
import static com.haxi.mh.utils.ui.smartrefreshlayout.util.SmartUtil.getColor;
import static com.haxi.mh.utils.ui.smartrefreshlayout.util.SmartUtil.isContentView;
...
//    }
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.haxi.mh.utils.ui.smartrefreshlayout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.haxi.mh.utils.ui.smartrefreshlayout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
