...
public interface RefreshInternal extends OnStateChangedListener {
    ...
    void onInitialized(@NonNull com.haxi.mh.utils.ui.smartrefreshlayout.api.RefreshKernel kernel, int height, int maxDragHeight);
     ...
     */
    @RestrictTo({LIBRARY, LIBRARY_GROUP, SUBCLASSES})
    void onReleased(@NonNull com.haxi.mh.utils.ui.smartrefreshlayout.api.RefreshLayout refreshLayout, int height, int maxDragHeight);
     ...
     */
    @RestrictTo({LIBRARY, LIBRARY_GROUP, SUBCLASSES})
    void onStartAnimator(@NonNull com.haxi.mh.utils.ui.smartrefreshlayout.api.RefreshLayout refreshLayout, int height, int maxDragHeight);
     ...
     */
    @RestrictTo({LIBRARY, LIBRARY_GROUP, SUBCLASSES})
    int onFinish(@NonNull com.haxi.mh.utils.ui.smartrefreshlayout.api.RefreshLayout refreshLayout, boolean success);
