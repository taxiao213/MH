...
public class QuickIndexLayout extends LinearLayout {
    ...
    public QuickIndexLayout(Context context, String[] index) {
        this(context, null, index);
    }

    public QuickIndexLayout(Context context, AttributeSet attrs, String[] index) {
        this(context, attrs, 0, index);
    }

    public QuickIndexLayout(Context context, AttributeSet attrs, int defStyleAttr, String[] index) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                this.setBackgroundColor(getResources().getColor(R.color.transportant));
