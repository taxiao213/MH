...
public class PointGesture {
    ...
    public PointGesture(int leftX, int rightX, int topY, int bottomY, ImageView image, int num) {
        super();
        this.leftX = leftX;
        this.rightX = rightX;
        this.topY = topY;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PointGesture other = (PointGesture) obj;
    ...
    public String toString() {
        return "PointGesture [leftX=" + leftX + ", rightX=" + rightX + ", topY="
