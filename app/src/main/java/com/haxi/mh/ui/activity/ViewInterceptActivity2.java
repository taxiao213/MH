...
public class ViewInterceptActivity2 extends BaseActivity {

    private HorizontalScrollViewEX horizontalScrollView;

    @Override
    protected int getLayoutRes() {
        return R.layout.activity_view_intercept2;
    }
    ...
    private void initView() {
        ...
        for (int i = 0; i < 3; i++) {
            ViewGroup inflate = (ViewGroup) layoutInflater.inflate(R.layout.activity_view_content2, horizontalScrollView, false);
    ...
    private void createList(ViewGroup inflate) {
        ListViewEx listView = inflate.findViewById(R.id.list);
