...
import com.haxi.mh.ui.activity.pay.dense.DenseActivity;
...
public class PayActivity extends BaseActivity {
    ...
    @OnClick({R.id.tv_alipay, R.id.tv_wxpay, R.id.tv_wxpay2, R.id.tv_ylpay, R.id.tv_dense})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_ylpay:
                ...
                break;
                case R.id.tv_dense:
                startActivity(new Intent(mActivity, DenseActivity.class));
                break;
        }
    }
}
